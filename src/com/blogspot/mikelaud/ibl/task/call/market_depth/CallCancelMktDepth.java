...
public class CallCancelMktDepth
	extends CallTaskEx<CallCancelMktDepth.Info>
{
	//------------------------------------------------------------------------
	...
	protected Task onCall() throws Exception {
		getClientSocket().cancelMktDepth(INFO.TICKER_ID);
		return null;
	}
	...
	public CallCancelMktDepth(ConnectionContext aContext, Info aInfo) {
		super(aContext, aInfo, CallType.cancelMktDepth);
	}
